...
class EmployeeController {
    ...
    EmployeeController(EmployeeRepository employeeRepository, EmployeeModelAssembler modelAssembler){
    ...
    CollectionModel<EntityModel<Employee>> getAll(){
     ...
     ResponseEntity<?> createEmployee(@RequestBody Employee newEmployee){
       EntityModel<Employee> entityModelEmployee = assembler.toModel(repository.save(newEmployee));

       return ResponseEntity.created(entityModelEmployee.getRequiredLink(IanaLinkRelations.SELF).toUri()).body(entityModelEmployee);
     }
